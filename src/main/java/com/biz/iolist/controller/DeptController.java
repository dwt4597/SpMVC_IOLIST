...
public class DeptController {
	...
	//Session deptVO가 아예 없거나, 내용이 제거되었을 경우 실행되어서
	//deptVO를 새로 만들어주는 method
	...
	/*
	 * ("deptVO") 강제로 이름 지정 -> 나중에 session을 쓸때 씀
	 */
	@RequestMapping(value="/write", method=RequestMethod.GET)
	public String write(
				@ModelAttribute("deptVO") DeptVO deptVO, Model model) {
